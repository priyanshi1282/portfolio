...
const ProjectCard = (props) => {
  return (
    <div className='flex items-center md:flex-row flex-col md:gap-10 gap-6 bg-white md:p-12 p-6 shadow-md rounded-lg '>
                ...
                <div className='flex flex-col md:gap-4 gap-3 justify-between'>
                    ...
                    <div>
                        <Image src={props.item.skills} width={200} height={200} className='md:w-[200px] w-auto' />
                    </div>
                    <div className='flex md:gap-6 gap-3'>
                        <Link className='btn btn-bg hover' href={props.item.demo}> Live Demo <FaExternalLinkAlt /></Link>
                        <Link href={props.item.repo} className='btn btn-outline hover'><FaGithub />Source Code</Link>
                    </div>
                </div>
            </div>
  )
